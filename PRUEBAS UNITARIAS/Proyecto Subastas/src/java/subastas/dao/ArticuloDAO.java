...
public class ArticuloDAO implements ArticuloIF {
    ...
    @Override
    public void registrarArticulo(String descripcion, String comentario, double precioBase, int idusuario, String fecha, int hora, String tiposubasta) {
        Connection con = null;
	              
		PreparedStatement pstmt = null;
		String sql = "INSERT INTO articulo (`descripcion`, `comentario`, `fotografia`, `precio base`, `id_usuario`, `fecha`, `hora`,`tipo_subasta`) VALUES (?,?,?,?,?,?,?,?);";
    ...
    public void registrarTablaSubasta(int idusuario, int idarticulo){
        Connection con = null;
	              
		PreparedStatement pstmt = null;
                String sql = "INSERT INTO subasta (`idarticulo`, `idusuario`) VALUES (?,?);";
