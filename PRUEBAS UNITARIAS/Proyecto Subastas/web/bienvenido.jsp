			...
			<div>
				<a href="#" class="filtro">
					Casa de Subastas
                                 ...
                                 <a href="/Subastas/index.jsp" class="organizar">
					Salir
				</a>
	...
	<div class="container">
		...
		<div class="main_content">
			...
			<div class="body">
                              ...
                              <h2 align="center "class="titulo">Bienvenido ${sessionScope.usuarioactual.nombre} 
                                  <h2 align="center">   Ahora que perteneces a nuestra comunidad puedes vender o participar de una subasta  </h2> </h2>
                                  
                                  <a  href="principalsubasta.jsp">Empezar la puja ya !! </a>
                                  
                              
				 <form action="BuscarConLogin" method="post">				    
				       <p><label for="articulo"><img src="imagenes/subastaYa.jpg" alt="Futbol5" width='200' height='200'/>Subastar YA!!!
                                        </label><input placeholder="Que estas buscando?" id="articulo" name="articulo" type="text" /></p>
				...
				<article class="partido">
					<div class="descripcion">
						...
						<div class="detalles">
							...
							<p class="autor">
								Comentario: <span class="nombreAutor"><%= c.getComentario() %></span> &nbsp &nbsp &nbsp 
							</p>
                                                        <p class="autor">
								Fecha: <span class="nombreAutor"><%= c.getDia() %></span> &nbsp &nbsp &nbsp &nbsp &nbsp Hora: <span class="nombreAutor"><%= c.getHora() %></span>
							</p>
							<p class="autor">
								Tipo Subasta <span class="nombreAutor"><%= c.getTiposubasta() %></span> &nbsp &nbsp &nbsp &nbsp &nbsp Precio Base (S/.): <span class="nombreAutor"><%= c.getPrecioBase() %></span>
							</p>
					...
					<div class="acciones">
						...
						<div class="registro">
                            <a href="AnotarseSubasta" class="inscribirse">Subastar!!</a>
						</div>
