...
<script>
    function mostrar(precioBase) {
     var mensaje;
    if (precioBase.value < 100){
        document.getElementById("tiposubasta").value= "CENTIMOS";
        }else{
         document.getElementById("tiposubasta").value= "DIRECTA";
        }
	...
	<div  class="container">
		<div class="main_content">
			...
			<div class="body">
                        ...
                        <p><label for="precioBase">Precio S/.</label><input placeholder="Fija el precio"  id="precioBase" name="precioBase" type="text" OnBlur="mostrar(precioBase);" /></p>
				...
				<select name="hora">
                        ...
                        <p><label for="tiposubasta">Tipo de Subasta sera: </label><input id="tiposubasta" name="tiposubasta" type="text" READONLY/></p>
